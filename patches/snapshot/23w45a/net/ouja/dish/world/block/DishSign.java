...
public class DishSign extends DishBlock implements WaterLoggableBlock, Sign {
    ...
    public DishSign(BlockPos pos, BlockTypes blockType, Block block, SignBlockEntity signBlockEntity) {
